...
public final class Version {
	...
	//同步OSS用户到CA时同步方式
	public final static String OSSSERVICE_SYNC_MODE="OSSService.sync.mode";
	/**
	 * The single instance.
	 */
	...
	/**
	 * OSS用户同步到CA时使用的模式
	 * @return 是否为ID相同的同步方式，否则为用户名相同
	 */
	public boolean ossSyncUserMode(){
		return "1".equals(Version.getInstance().getProperty(OSSSERVICE_SYNC_MODE)) ? true : false;
	}
