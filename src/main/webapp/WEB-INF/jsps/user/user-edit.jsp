				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="100%" align="left" valign="top">
										...
										<div class="lingyong_sm">
											<h1>
												...
												<div class="dawem_bt">
													<dt>
														<img
															src="<%=request.getContextPath()%>/images/tongyi/ewr22.jpg"
															height="25" />
													</dt>
							...
							<form action="<%=request.getContextPath()%>/user/user!edit.action" method="post" id="adduser" onsubmit="return formCheck();">
								...
								<div class="works_ss_tiaojian">
									...
									<div class="add_work_od" style="text-align: center">
										...
										<ul>
											...
											<li>
												<input name="user.realName" type="text" value="<s:property value="user.realName"/>" class="all_input" size="28"
													id="userrealName" />
												&nbsp;
											</li>
											<li>
										...
										<ul>
											...
											<li>
												<input name="user.employeeNo" type="text" class="all_input" value="<s:property value="user.employeeNo"/>" size="28" id="useremployeeNo" />
												&nbsp;
											</li>
											<li>
												<i>*</i>&nbsp;选填，请填写用户的工号，支持英文字母、数字及符号！
											</li>
											<li>
										...
										<ul>
											...
											<li>
												<input name="user.internetAccount" type="text" class="all_input" value="<s:property value="user.internetAccount"/>"
													style="width: 355px" id="internetAccount" />
												&nbsp;
											</li>
											<li>
												<i>*</i>&nbsp;选填，请输入用户的上网账号，字符不限！
											</li>
											<li>
											...
											<li>
												<select name="workGroupId" id="selectWorkGroup"  class="inp_wid360" style="font-family:Tahoma, Geneva, sans-serif">
																			...
																			<s:iterator value="workGroupList" var="workGroup">
																				<option value='<s:property value="id" />' <s:if test="user.workGroup.id==id"> selected</s:if>> 
											...
											<li>
												<select name="depetId"	id="selectuserdept"  class="inp_wid360" class="inp_wid360" style="font-family:Tahoma, Geneva, sans-serif">
																			...
																			<s:iterator value="userDeptList" var="userDept">
																				<option value='<s:property value="id" />' <s:if test="user.depet.id==id"> selected</s:if>>
										...
										<ul>
											...
											<li>
												<textarea name="user.taskNotifier" cols="90" rows="5" 
													id="usertaskNotifier" class=" all_textarea "><s:property value="user.taskNotifier"/></textarea>
												&nbsp;
											</li>
											<li>
									...
									<div class="add_work_od" style="text-align: center">
										<ul>
											...
											<li>
												<input name="user.mail" type="text" class="all_input inp_wid360" value="<s:property value="user.mail"/>"
													size="22" id="usermail"/>&nbsp;
											</li>
										...
										<ul>
											...
											<li>
												<input name="user.mobile" type="text" class="all_input inp_wid360" value="<s:property value="user.mobile"/>"
										...
										<ul>
											...
											<li>
												<input name="user.fax" type="text" class="all_input inp_wid360" value="<s:property value="user.fax"/>"
													size="22" id="userfax"/>
												&nbsp;
											</li>
											<li>
												<i>*</i>&nbsp;选填，请填写用户传真号码，仅支持数字且不得小于8位数！
											</li>
											<li>
										...
										<ul>
											...
											<li>
												<input name="user.office" type="text" class="all_input inp_wid360" value="<s:property value="user.office"/>"
													size="22" id="useroffice"/>
												&nbsp;
											</li>
											<li>
												<i>*</i>&nbsp;选填，请填写用户的固定电话号码，仅支持数字且不得小于8位数！
											</li>
											<li>
										...
										<ul>
											...
											<li>
												<input name="user.msn" type="text" class="all_input inp_wid360" value="<s:property value="user.msn"/>"
													size="22" id="usermsn"/>
												&nbsp;
											</li>
											<li>
										...
										<ul>
											...
											<li>
												<input name="user.qq" type="text" class="all_input inp_wid360" value="<s:property value="user.qq"/>"
													size="22" id="qq"/>
												&nbsp;
											</li>
											<li>
									...
									<div class="add_work_od" style="text-align: center">
										<ul>
											...
											<li>
												<input name="user.country" type="text" class="all_input inp_wid360" value="<s:property value="user.country"/>"
										...
										<ul>
											...
											<li>
												<input name="user.city" type="text" class="all_input inp_wid360" value="<s:property value="user.city"/>"
													size="22" id="usercity" />
												&nbsp;
											</li>
											<li>
										...
										<ul>
											...
											<li>
												<input name="user.address" type="text" class="all_input inp_wid360" value="<s:property value="user.address"/>"
										...
										<ul>
											...
											<li>
												<input name="user.zipCode" type="text" class="all_input inp_wid360" value="<s:property value="user.zipCode"/>"
