...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script
			src="<%=request.getContextPath()%>/js/uums/userDept/userDept.js"></script>
	...
	<body onload="init()">
		...
		<input type="hidden" id="deptId"
			value="<s:property value="userDept.id" />" />
											...
											<table width="100%" height="28" border="0">
												<tr>
													<td width="48%" align="center">
														<a href="#" onclick="deleteUserDeptMember()"><div
																class="button_blue">
																确&nbsp;&nbsp;定
															</div> </a>
													</td>
													...
													<div class="cmdb_cha">
														<div class="jiaosetop_margin6px">
															<input name="" type="button" class="all_butt add_jiaose"
																value="添加用户"
																onclick="changeuser(<s:property value="userDept.id" />)" />
															<input name="" type="button" class="all_butt add_jiaose2"
																value="返回"
																onclick="window.location.href='<%=request.getContextPath()%>/userdept/user-dept!list.action'" />
														</div>
													</div>
												</div>
															...
															<s:iterator value="userList" var="user"
																...
																<td>
																	<input type="button" class="all_butt chakan_bn"
																		value="删除" name=""
																		onclick="confirmDeleteUserDeptMember(<s:property value="id"/>)" />
																</td>
																</tr>
															</s:iterator>
														</s:if>
												...
												<div class="fenye_css">
													<div class="fenye_coun">
														<uums:page currentPage="${currentPage}"
															...
															url="/uums/userdept/user-dept!showUser.action" />
