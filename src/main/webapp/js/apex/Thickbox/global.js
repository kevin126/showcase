...
//parseCode('/itsm/js/apex/Thickbox/thickbox.js','ajaxJS');
//parseCode('/itsm/js/apex/Thickbox/thickbox.css','ajaxCSS');
//parseCode('/itsm/js/apex/Thickbox/thickbox-compressed.js','ajaxJSCompressed');
