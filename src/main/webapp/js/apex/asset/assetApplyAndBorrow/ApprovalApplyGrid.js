...
Apex.asset.ApprovalApplyGrid = function() {
				...
				proxy : new Ext.ux.data.DWRProxy({
							...
							listeners : {
								'beforeload' : function(dataProxy, params) {
									var userId = applicantId.getValue();
									var code = orderCodeText.getValue();
									var departmentId = deptIdText.getValue();
									var loadArgs = [code, userId, departmentId,
