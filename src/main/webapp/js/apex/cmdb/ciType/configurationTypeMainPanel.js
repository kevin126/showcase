...
Apex.configuration.configurationTypeMainPanel = function() {
	var task = new Apex.configuration.configurationTypeView();
...
Ext.onReady(function() {
	SecurityService.getUserVoByUserName(null, {
		callback : function(user) {
			...
			maintenanceMainPanel = new Apex.configuration.configurationTypeMainPanel();
