	...
	ShadeFactory = {
		get_Instance : function(backgroundColor, alpha, zindex) {
			if (Shade.instance == null) {
				...
				if (alpha != null) {
					Shade.instance.ShadeDiv.style.filter = "alpha(opacity="
							+ alpha + ")";
				} else {
...
function BuildConfirmDiv() {
	...
	strConfirm += "      <tr>";
	strConfirm += "        <td><div class='message_div'>请确认</div>";
	strConfirm += "          <div class='message_close'><a href='#'><img  id='confirmCloseButton'  style='cursor:pointer;' src='../images/confirmClose.gif' alt='Close' title='Close' width='40' height='40' /></a></div></td>";
	strConfirm += "      </tr>";
	strConfirm += "    </table>";
	strConfirm += "  </div>";
	...
	strConfirm += "      </tr>";
	strConfirm += "      <tr>";
	strConfirm += "        <td class='message_leftcontain'><img src='../images/confirmQuery.gif' alt='Query' title='Alert' width='40' height='40' /></td>";
	strConfirm += "        <td class='message_rightcontain'><div id='confirmMessageDiv'>";
	strConfirm += "                </div>";
	strConfirm += "      </tr>";
	strConfirm += "      <tr>";
	strConfirm += "        <td colspan='2' height='10'>&nbsp;</td>";
	strConfirm += "      </tr>";
	strConfirm += "      <tr>";
	strConfirm += "        <td colspan='2' class='message_button'><input  id='confirmOKButton'  class='button_short' type='button' name='btnOk' value='确&nbsp;&nbsp;定'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  id='confirmCancelButton'  class='button_short' type='button' name='btnOk' value='取&nbsp;&nbsp;消'/></td>";
	strConfirm += "      </tr>";
	strConfirm += "    </table>";
	strConfirm += "  </div>";
	...
	var obj = document.createElement("div");
        ...
        var Bmhtml=strConfirm;
        obj.innerHTML=Bmhtml;
...
var version = parseInt(strVersion.substring(strVersion.indexOf("MSIE") + 4,
		strVersion.indexOf("MSIE") + 8));
...
window.confirm = function(message, okCallBack, cancelCallBack) {
	...
	confirmDiv.style.top = document.documentElement.scrollTop
			+ (document.documentElement.clientHeight - parseInt(confirmDiv.offsetHeight))
			/ 2 + "px";
	confirmDiv.style.left = document.documentElement.scrollLeft
			+ (document.documentElement.clientWidth - parseInt(confirmDiv.offsetWidth))
			/ 2 + "px";
